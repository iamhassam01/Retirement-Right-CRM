      ...
      <div className="p-4 border-t border-slate-800 bg-[#0B1120] shrink-0">
        <div className={`flex items-center gap-3.5 w-full p-2.5 rounded-xl ${isCollapsed ? 'justify-center' : 'text-left'}`}>
          ...
          <div className="relative">
            <div className="w-10 h-10 rounded-full border-2 border-slate-700 bg-gradient-to-br from-teal-500 to-emerald-600 flex items-center justify-center text-white font-bold text-sm">
              {getUserInitials()}
            </div>
